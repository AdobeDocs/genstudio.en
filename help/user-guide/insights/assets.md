...
The [!DNL Insights] _[!UICONTROL Assets]_ view shows a list of assets used in ad campaigns for the connected channel account.

The _[!UICONTROL Assets]_ gallery is the default view, showing a collage of assets previews and a metric, such as click-through rate. Click the settings (cog) icon above the right side of the gallery to toggle the viewable metric: `click-through rate`, `cost per click`, or `spend`.
